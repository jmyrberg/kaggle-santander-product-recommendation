"""
Script for combining multiple submission with weights
...
## input files ##
sub1 = csv.DictReader(open("./submission1.csv"))
sub2 = csv.DictReader(open("./submission2.csv"))
sub3 = csv.DictReader(open("./submission3.csv"))

## output file ##
out = open("./ensembled_submission.csv", "w")
